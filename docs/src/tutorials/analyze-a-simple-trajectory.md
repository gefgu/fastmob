...
We will use pandas so the example is easy to read. skmob2 can also work with other eager dataframe backends; when you are ready to adapt this example to your own column names or backend, see [Use custom columns and dataframe backends](../how-to-guides/use-custom-columns-and-dataframe-backends.md).
