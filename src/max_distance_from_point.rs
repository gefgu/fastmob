...
fn max_distance_from_point_impl(
    home_lats: &[f64],
    home_lngs: &[f64],
    latitudes: &[f64],
    longitudes: &[f64],
...
pub(crate) fn max_distance_from_point_numpy<'py>(
    py: Python<'py>,
    ...
    Ok(max_distance_from_point_impl(
        home_lats.as_slice()?,
        home_lngs.as_slice()?,
        latitudes.as_slice()?,
        longitudes.as_slice()?,
...
#[pyfunction]
pub(crate) fn max_distance_from_point_arrow(
    home_lats: PyArray,
    home_lngs: PyArray,
    latitudes: PyArray,
    longitudes: PyArray,
    ...
    Ok(f64_results_into_arrow(max_distance_from_point_impl(
