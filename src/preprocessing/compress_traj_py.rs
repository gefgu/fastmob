...
#[pyfunction]
pub(crate) fn compress_trajectory_representatives_arrow(
...
pub(crate) fn compress_trajectory_representatives_indexed_numpy<'py>(
    py: Python<'py>,
    latitudes: PyReadonlyArray1<'py, f64>,
    longitudes: PyReadonlyArray1<'py, f64>,
...
#[pyfunction]
#[allow(clippy::too_many_arguments)]
pub(crate) fn compress_trajectory_representatives_indexed_arrow(
    latitudes: ArrowPyArray,
    longitudes: ArrowPyArray,
