"""Correctness tests for skmob2.measures.collective.uncorrelated_location_entropy."""
...
from skmob2.measures.collective.uncorrelated_location_entropy import uncorrelated_location_entropy
