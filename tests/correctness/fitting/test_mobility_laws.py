"""Correctness tests for fastmob.measures.fitting.mobility_laws — power-law fitting."""
...
def test_bin_visitation_law_data_filters_zero_distance_and_computes_density():
    import pandas as pd
    from fastmob.measures.fitting.mobility_laws import bin_visitation_law_data
...
def test_fit_visitation_law_recovers_known_exponent_and_curve():
    from fastmob.measures.fitting.mobility_laws import fit_visitation_law
...
def test_visitation_law_invalid_inputs_raise():
    from fastmob.measures.fitting.mobility_laws import (
