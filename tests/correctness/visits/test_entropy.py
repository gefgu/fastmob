...
def test_fano_solve_zero_entropy_returns_one():
    ...
    from skmob2.measures.visits.entropy import _solve_max_predictability_with_fano
...
def test_trajectory_entropy_result_shape():
    ...
    from skmob2.measures.visits.entropy import trajectory_entropy
    df = _entropy_visits()
...
def test_trajectory_predictability_result_columns():
    ...
    from skmob2.measures.visits.entropy import trajectory_predictability
    df = _entropy_visits()
