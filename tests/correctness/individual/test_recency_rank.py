...
def test_recency_rank_known_values(synthetic_tdf):
    ...
    from skmob2.measures.individual.recency_rank import recency_rank
...
def test_recency_rank_presorted_core_validation_errors():
    ...
    from skmob2._core import recency_rank_presorted_numpy
...
def test_recency_rank_matches_skmob(comparison_skmob):
    ...
    from skmob2.measures.individual.recency_rank import recency_rank as skmob2_rr
...
def test_recency_rank_matches_cached_reference(comparison_skmob_reference):
    ...
    skmob2_result = skmob2_rr(ref.input_df)
