...
PRIVACY_CASES = (
    ...
    PrivacyCase(
        ...
        {"knowledge_length": 3, "targets": [1, 2], "force_instances": True},
    ),
    ...
    PrivacyCase(
        "location_sequence_targets_kl3", privacy.location_sequence_risk, {"knowledge_length": 3, "targets": [1, 2]}
    ),
    PrivacyCase(
    ...
    PrivacyCase(
        "location_time_month_kl2", privacy.location_time_risk, {"knowledge_length": 2, "time_precision": "Month"}
    ),
    PrivacyCase(
        "location_time_month_kl3", privacy.location_time_risk, {"knowledge_length": 3, "time_precision": "Month"}
    ),
    PrivacyCase(
        "location_time_month_targets_kl3",
        privacy.location_time_risk,
        {"knowledge_length": 3, "time_precision": "Month", "targets": [1, 2]},
    ),
    PrivacyCase(
        "location_time_month_force_instances_kl3",
        privacy.location_time_risk,
        {"knowledge_length": 3, "time_precision": "Month", "targets": [1, 2], "force_instances": True},
    ),
    ...
    PrivacyCase(
        "unique_location_targets_kl3", privacy.unique_location_risk, {"knowledge_length": 3, "targets": [1, 2]}
    ),
    PrivacyCase(
    ...
    PrivacyCase(
        "location_frequency_tol05_kl2", privacy.location_frequency_risk, {"knowledge_length": 2, "tolerance": 0.5}
    ),
    PrivacyCase("location_frequency_kl3", privacy.location_frequency_risk, {"knowledge_length": 3}),
    PrivacyCase(
        "location_frequency_targets_kl3", privacy.location_frequency_risk, {"knowledge_length": 3, "targets": [1, 2]}
    ),
    PrivacyCase(
    ...
    PrivacyCase(
        "location_probability_tol05_kl2", privacy.location_probability_risk, {"knowledge_length": 2, "tolerance": 0.5}
    ),
    ...
    PrivacyCase(
        ...
        {"knowledge_length": 3, "targets": [1, 2]},
    ),
    PrivacyCase(
    ...
    PrivacyCase(
        "location_proportion_tol05_kl2", privacy.location_proportion_risk, {"knowledge_length": 2, "tolerance": 0.5}
    ),
    PrivacyCase("location_proportion_kl3", privacy.location_proportion_risk, {"knowledge_length": 3}),
    PrivacyCase(
        "location_proportion_targets_kl3", privacy.location_proportion_risk, {"knowledge_length": 3, "targets": [1, 2]}
    ),
    PrivacyCase(
...
def _normalized(df: Any) -> pd.DataFrame:
    ...
    return (
        out.sort_values(list(out.columns), kind="mergesort")
...
def test_privacy_toy_matches_cached_skmob_pandas(privacy_toy_reference, case: PrivacyCase):
    ...
    if "datetime" not in actual and "datetime" in expected:
        expected = (
            expected.drop(columns="datetime")
            .sort_values(list(expected.columns.drop("datetime")), kind="mergesort")
            .reset_index(drop=True)
        )
