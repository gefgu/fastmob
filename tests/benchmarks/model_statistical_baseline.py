...
Usage:
    ...
    python tests/benchmarks/model_statistical_baseline.py --library skmob2

    # skmob baseline (run in .venv-skmob)
    python tests/benchmarks/model_statistical_baseline.py --library skmob

    # Custom output path
    python tests/benchmarks/model_statistical_baseline.py \\
...
def _import_spatial() -> Any:
    return importlib.import_module("skmob2.measures.spatial")
