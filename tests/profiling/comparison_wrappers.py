...
def column_distribution_wasserstein(df: Any) -> Any:
    from skmob2.comparison import column_distribution_wasserstein_distance
...
def column_distribution_jsd(df: Any) -> Any:
    from skmob2.comparison import column_distribution_jensen_shannon_divergence
...
def visits_per_user_wasserstein(df: Any) -> Any:
    from skmob2.comparison import visits_per_user_wasserstein_distance
...
def visits_per_user_jsd(df: Any) -> Any:
    from skmob2.comparison import visits_per_user_jensen_shannon_divergence
