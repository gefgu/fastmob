...
class FlowDataFrame(BaseDataFrame):
    ...
    ...     "flow": [100, 50, 30],
    ... })
    >>> fdf = skmob2.FlowDataFrame(flows)
    >>> fdf.get_flow("A", "B")
    50
    """
    ...
    def settings_from(self, other: "FlowDataFrame") -> None:
        ...
        >>> fdf1 = skmob2.FlowDataFrame(flows.copy())
        >>> fdf2 = skmob2.FlowDataFrame(flows.copy(), parameters={"year": 2020})
    ...
    def get_geometry(self, tile_id: str):
        ...
        Examples
        --------
        >>> import skmob2  # doctest: +SKIP
        >>> fdf = skmob2.data.load_dataset("flow_foursquare_nyc")  # doctest: +SKIP
    ...
    def plot_flows(
        ...
        style_function : callable, optional
            ...
            ``skmob2.utils.plot.flow_style_function``.
