...
_ROW_ORDER_COL = "__fkmob_row_order__"
_USER_RANGE_START_COL = "__fkmob_user_range_start__"
...
def _indexed_group_indices_numpy(uids: Any, num_groups: int) -> Any:
    from fkmob._core import radius_of_gyration_user_indices_numpy  # noqa: PLC0415

    return radius_of_gyration_user_indices_numpy(uids, num_groups)


def _indexed_group_indices_arrow(uids: Any, num_groups: int) -> Any:
    from fkmob._core import radius_of_gyration_user_indices_arrow  # noqa: PLC0415
...
def _time_ordered_user_indices_numpy(
    ...
    from fkmob._core import time_ordered_user_indices_numpy  # noqa: PLC0415
...
def _time_ordered_user_indices_arrow(
    ...
    from fkmob._core import time_ordered_user_indices_arrow  # noqa: PLC0415
...
def _build_time_ordered_user_ranges(
    ...
    timestamps_data: Any,
    *,
    row_index_col: str = "__fkmob_time_order_row_index__",
    ...
    index_df = (
        ...
        .sort("__fkmob_uid_codes__", datetime_col, row_index_col)
    )
...
def _build_indexed_user_ranges(
    ...
    uid_col: str,
    *,
    row_index_col: str = "__fkmob_indexed_row_index__",
