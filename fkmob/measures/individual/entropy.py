...
from fkmob._core import trajectory_entropy_batch as _trajectory_entropy_batch_rust
from fkmob._core import trajectory_predictability_batch as _trajectory_predictability_batch_rust
...
def trajectory_entropy(
    ...
    --------
    >>> import pandas as pd
    >>> from fkmob.measures.individual import trajectory_entropy
    >>> visits = pd.DataFrame(
    ...     {
    ...
    location_key_col = "__fkmob_location_key__"
...
def trajectory_predictability(
    ...
    --------
    >>> import pandas as pd
    >>> from fkmob.measures.individual import trajectory_predictability
    >>> visits = pd.DataFrame(
    ...     {
    ...         "user_id": ["u1", "u1", "u1", "u1", "u2", "u2", "u2"],
    ...         "start_timestamp": pd.to_datetime(
