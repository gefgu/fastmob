...
def common_part_of_commuters(values1, values2) -> float:
    ...
    Examples
    --------
    >>> from fkmob import common_part_of_commuters
...
def common_part_of_links(values1, values2) -> float:
    ...
    Examples
    --------
    >>> from fkmob import common_part_of_links
    >>> observed = [10, 0, 30, 0]
    >>> predicted = [5, 7, 0, 0]
...
def common_part_of_commuters_distance(values1, values2) -> float:
    ...
    Examples
    --------
    >>> from fkmob import common_part_of_commuters_distance
    >>> observed = [1, 2, 4, 8]
    >>> predicted = [1, 3, 5, 9]
...
def information_gain(true, pred) -> float:
    ...
    Examples
    --------
    >>> from fkmob import information_gain
    >>> observed = [10, 20, 30, 40]
    >>> predicted = [12, 18, 33, 37]
...
def kullback_leibler_divergence(true, pred) -> float:
    ...
    Examples
    --------
    >>> from fkmob import kullback_leibler_divergence
    >>> observed = [10, 20, 30, 40]
    >>> predicted = [12, 18, 33, 37]
    ...
    if _scipy_stats is None:
        raise ImportError("scipy is required for kullback_leibler_divergence: pip install fkmob[fitting]")
...
def pearson_correlation(true, pred) -> tuple[float, float]:
    ...
    Examples
    --------
    >>> from fkmob import pearson_correlation
    >>> observed = [10, 20, 30, 40]
    >>> predicted = [12, 18, 33, 37]
    ...
    """
    if _scipy_stats is None:
        raise ImportError("scipy is required for pearson_correlation: pip install fkmob[fitting]")
...
def spearman_correlation(true, pred) -> tuple[float, float]:
    ...
    Examples
    --------
    >>> from fkmob import spearman_correlation
    >>> observed = [10, 20, 30, 40]
    >>> predicted = [12, 18, 33, 37]
    ...
    """
    if _scipy_stats is None:
        raise ImportError("scipy is required for spearman_correlation: pip install fkmob[fitting]")
