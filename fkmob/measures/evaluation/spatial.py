...
from fkmob._core import stvd_emd_arrow as _stvd_emd_arrow
from fkmob._core import stvd_emd_numpy as _stvd_emd_numpy
...
from fkmob.measures._common import (
    DURATION_CANDIDATES,
    _as_index_array,
...
def dwell_time_wasserstein_distance(
    ...
    *,
    ...
    def add_hours(data: Any) -> Any:
        ...
        return native.with_columns((nw.col(duration_col) / 60.0).alias("__fkmob_dwell_hours__")).to_native()

    return column_distribution_wasserstein_distance(
        add_hours(df1),
        add_hours(df2),
        "__fkmob_dwell_hours__",
        hue=hue,
        day_col1=day_col1,
        day_col2=day_col2,
