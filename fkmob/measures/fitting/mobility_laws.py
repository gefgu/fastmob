...
from fkmob._core import visitation_distances_arrow, visitation_distances_numpy
...
def fit_values_to_truncated_powerlaw(
    ...
    if _scipy_curve_fit is None:
        raise ImportError("scipy is required for power-law fitting: pip install fkmob[fitting]")
