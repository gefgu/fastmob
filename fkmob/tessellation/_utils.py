...
def _require_geopandas():
    try:
        ...
        raise ImportError("geopandas is required for tessellation: pip install fkmob[tessellation]") from exc
    return gpd
...
def _require_requests():
    try:
        ...
        raise ImportError("requests is required for string place tessellation: pip install fkmob[tessellation]") from exc
    return requests
...
def nearest(origin, tessellation, col: str):
    ...
    from fkmob.models._common import haversine_km
