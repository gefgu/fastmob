...
class FlowDataFrame(BaseDataFrame):
    ...
    def settings_from(self, other: "FlowDataFrame") -> None:
        ...
        >>> fdf1 = fkmob.FlowDataFrame(flows.copy())
        >>> fdf2 = fkmob.FlowDataFrame(flows.copy(), parameters={"year": 2020})
    ...
    def get_geometry(self, tile_id: str):
        ...
        Examples
        --------
        >>> import fkmob  # doctest: +SKIP
        >>> fdf = fkmob.data.load_dataset("flow_foursquare_nyc")  # doctest: +SKIP
    ...
    def plot_flows(
        ...
        style_function : callable, optional
            ...
            ``fkmob.utils.plot.flow_style_function``.
