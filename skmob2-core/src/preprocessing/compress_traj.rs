...
pub type CompressRepresentatives = (Vec<usize>, Vec<f64>, Vec<f64>);
type CompressRepresentativeRow = (usize, f64, f64);

pub fn compress_user_slice(
    lats: &[f64],
    lngs: &[f64],
...
pub fn compress_trajectory_representatives_impl(
    lats: &[f64],
    lngs: &[f64],
    ranges: &[(usize, usize)],
    spatial_radius_km: f64,
...
pub fn compress_trajectory_representatives_indexed_impl(
    lats: &[f64],
    lngs: &[f64],
