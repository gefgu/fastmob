...
Run from the repository root, for example:
    ...
    python benchmarks/speed_comparison_suite.py --backend pandas --sizes 10000
    python benchmarks/speed_comparison_suite.py --backend polars --sizes 1000 10000 100000
"""
