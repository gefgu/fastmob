...
Run from the repository root, for example:
    ...
    python benchmarks/speed_visits_suite.py --library skmob2 --backend both
    python benchmarks/speed_visits_suite.py --library skmob
"""
...
VISITS_METRICS: tuple[BenchmarkSpec, ...] = (
    BenchmarkSpec("random_entropy", "skmob2.measures.individual.random_entropy", "skmob.measures.individual", "random_entropy", {}),
    BenchmarkSpec(
    ...
    BenchmarkSpec("real_entropy", "skmob2.measures.individual.real_entropy", "skmob.measures.individual", "real_entropy", {}),
    BenchmarkSpec(
        "location_frequency",
    ...
    BenchmarkSpec("recency_rank", "skmob2.measures.individual.recency_rank", "skmob.measures.individual", "recency_rank", {}),
    BenchmarkSpec(
        "frequency_rank",
