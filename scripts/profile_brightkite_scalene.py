...
def build_profile_command(
    ...
    *,
    ...
    if implementation == "fastmob" and backend != "pandas":
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description=__doc__,
        epilog=(
            "By default, Scalene profiles the jump_lengths workload for both fastmob and skmob. "
    ...
    parser.add_argument("--implementation", choices=("fastmob", "skmob", "both"), default="both")
    parser.add_argument(
        "--jump-lengths-entrypoint",
