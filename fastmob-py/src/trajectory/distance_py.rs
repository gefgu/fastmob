...
use crate::adapters::trajectory::run_two_sequence_arrow;
...
pub fn trajectory_distance(
    ...
    match config.method.as_str() {
        ...
        "frechet" => run_two_sequence_arrow(
            py,
            latitudes_a,
            longitudes_a,
            latitudes_b,
        ...
        "hausdorff" => run_two_sequence_arrow(
            py,
            latitudes_a,
            longitudes_a,
            latitudes_b,
